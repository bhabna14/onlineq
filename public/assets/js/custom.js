...
/* ***************************************************
    ==========load functionality start==========
    ******************************************************/

function loadOnchange(firstid, secondid, url, token) {
    var firstid = $("#" + firstid).val();
    $.ajax({
        type: "POST",
        url: url,
        data: { _token: token, firstid: firstid },
        dataType: "json",
...
function loadOnchangeCity(firstid, secondid, url, token) {
    var firstid = $("#" + firstid).val();
    $.ajax({
        type: "POST",
        url: url,
        ...
        success: function (res) {
            var data = `<option value='0'>--select--</option>`;
            for (var i in res) {
                data += `<option value=${res[i].Name}>${res[i].Name}</option>`;
            }
            $("#" + secondid).html(data);
        },
    });
...
/* ***************************************************
    ==========modalities undertaking checkbox toggle for button disable and enable==========
    ******************************************************/

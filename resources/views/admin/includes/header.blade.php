    ...
    <div class="container-fluid">
        ...
        <div class="navbar-brand flex-1 flex-lg-0">
            <a href="{{ route('home') }}" class="d-inline-flex align-items-center">
                ...
                <img src="{{ asset('/assets') }}/images/flag.gif" alt="">
                <img src="{{ asset('/assets') }}/images/sjs-new-logo.gif" class="d-none d-sm-inline-block h-16px ms-3" alt="">
            </a>
        </div>
                    ...
                    <div class="dropdown-menu-scrollable pb-2">
                        <a href="#" class="dropdown-item align-items-start text-wrap py-2">
                            <div class="status-indicator-container me-3">
                                <img src="{{ asset('/assets') }}/admin/images/demo/users/face10.jpg"
                        ...
                        <a href="#" class="dropdown-item align-items-start text-wrap py-2">
                            <div class="status-indicator-container me-3">
                                <img src="{{ asset('/assets') }}/admin/images/demo/users/face3.jpg"
                                    class="w-40px h-40px rounded-pill" alt="">
                        ...
                        <a href="#" class="dropdown-item align-items-start text-wrap py-2">
                            <div class="status-indicator-container me-3">
                                <img src="{{ asset('/assets') }}/admin/images/demo/users/face24.jpg"
                                    class="w-40px h-40px rounded-pill" alt="">
                                <span class="status-indicator bg-success"></span>
                            </div>
                            <div class="flex-1">
                        ...
                        <a href="#" class="dropdown-item align-items-start text-wrap py-2">
                            <div class="status-indicator-container me-3">
                                <img src="{{ asset('/assets') }}/admin/images/demo/users/face4.jpg"
                                    class="w-40px h-40px rounded-pill" alt="">
                        ...
                        <a href="#" class="dropdown-item align-items-start text-wrap py-2">
                            <div class="status-indicator-container me-3">
                                <img src="{{ asset('/assets') }}/admin/images/demo/users/face25.jpg"
                                    class="w-40px h-40px rounded-pill" alt="">
                ...
                <div class="form-control-feedback form-control-feedback-start flex-grow-1" data-color-theme="dark">
                    ...
                    <div class="dropdown-menu w-100" data-color-theme="light">
                        ...
                        <div class="dropdown-menu-scrollable-lg">
                            ...
                            <div class="dropdown-item cursor-pointer">
                                <div class="me-3">
                                    <img src="{{ asset('/assets') }}/admin/images/brands/adobe.svg"
                                        class="w-32px h-32px rounded-pill" alt="">
                                </div>
                            ...
                            <div class="dropdown-item cursor-pointer">
                                <div class="me-3">
                                    <img src="{{ asset('/assets') }}/admin/images/brands/holiday-inn.svg"
                                        class="w-32px h-32px rounded-pill" alt="">
                                </div>
                            ...
                            <div class="dropdown-item cursor-pointer">
                                <div class="me-3">
                                    <img src="{{ asset('/assets') }}/admin/images/brands/ing.svg"
                                        class="w-32px h-32px rounded-pill" alt="">
                                </div>
            ...
            <li class="nav-item nav-item-dropdown-lg dropdown ms-lg-2">
                {{-- <a href="#" class="navbar-nav-link align-items-center rounded-pill p-1" data-bs-toggle="dropdown">
                    <div class="status-indicator-container">
                        <img src="{{ asset('/assets') }}/admin/images/demo/users/face11.jpg" class="w-32px h-32px rounded-pill"
                            alt="">
                        <span class="status-indicator bg-success"></span>
                    </div>
                ...
                <a href="{{ route('admin.logout') }}" class="navbar-nav-link align-items-center rounded-pill p-1">
                    <i class="ph-power"></i>
                    <span class="d-none d-lg-inline-block mx-lg-2">Logout</span>
                </a>
            </li>
        </ul>
    </div>
